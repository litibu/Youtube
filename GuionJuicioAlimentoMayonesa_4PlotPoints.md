...
```mermaid
graph TD
    A[Acto I: Apertura y Acusacion Formal] -->|PP1: Pregunta Suspendida| B[Acto II: Antecedentes e Historia de la Emulsion]
    B --> C[Acto III: Pruebas de la Fiscalia]
    C -->|PP2: Revelacion Forense de Etiqueta| D[Acto IV: Alegatos de la Defensa]
    D -->|PP3: Testimonio de la Acusada| E[Acto V: Careo de Datos Duros]
    E --> F[Acto VI: Sentencia y Veredicto de Compra]
    F -->|PP4: Pausa Previa al Veredicto| G[Cierre: Conclusion y Recomendaciones]
```
